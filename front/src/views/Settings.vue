    ...
    <div class="Settings-container">
      ...
      <div class="SettingsCart-container">
        ...
        <div class="SettingsCart-container_checkboxes">
          <p for="RadBtnVK" >VK</p>
          <input id="RadBtnVK"  type="radio" v-model="SettingForm.sourse"  value="VK">
          <p for="RadBtnRSS" >RSS</p>
          <input id="RadBtnRSS"  type="radio" v-model="SettingForm.sourse" value="RSS">
        </div>
        ...
        <div class="KeyWords-container">
          <input class="KeyWords-container_input" placeholder="Add Key Word" @keyup.enter="addKey" v-model="keyword">
          <div v-for="(keyWord, key) in SettingForm.keyWords" :key="key">
                <button class="KeyWords-container_keyword">{{keyWord}}</button>
                <i class="KeyWords-container-icon fas fa-trash-alt"  @click="deleteKeyWord"></i>
          </div>
        </div>
